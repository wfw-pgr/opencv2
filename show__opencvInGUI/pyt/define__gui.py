...
class gui__template( ttk.Frame ):
    ...
    def __init__( self, root=None, width=400, height=800 ):
        ...
        self.set__matplotlibWindow( key="plot" )
    ...
    def define__positionsOfWidgets( self ):
        ...
        self.posits ["plot"]             = [  0.1,  0.6, 0.8, 0.3 ]
    ...
    # ========================================================= #
    def set__matplotlibWindow( self, key="plot" ):
        fig, ax            = list( plt.subplots( tight_layout=True ) )
        ax.set_xticks     ( np.linspace(  0.0, 1.0, 3 ) )
        ax.set_yticks     ( np.linspace( -1.0, 1.0, 5 ) )
        ax.set_xticklabels( np.linspace(  0.0, 1.0, 3 ), fontsize=8 )
        ax.set_yticklabels( np.linspace( -1.0, 1.0, 5 ), fontsize=8 )
        ax.set_xlim(    0, 1.0 )
        ax.set_ylim( -1.0, 1.0 )
