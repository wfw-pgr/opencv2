...
def mark__CannyHough():
    ...
    print( " time for load figures        :: {} (s)".format( ( time1e-time1s ) / nFrames ) )
    print( " time for canny-Hough         :: {} (s)".format( ( time2e-time2s ) / nFrames ) )
    print( " time for save figures        :: {} (s)".format( ( time3e-time3s ) / nFrames ) )
