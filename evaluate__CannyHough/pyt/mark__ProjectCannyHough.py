...
def mark__ProjectCannyHough():
    ...
    print( "[mark__ProjectCannyHough.py] time for perpectiveTransform :: {} (s)".format( time1e-time1s ) )
    print( "[mark__ProjectCannyHough.py] time for canny-Hough         :: {} (s)".format( time2e-time2s ) )
    return()
