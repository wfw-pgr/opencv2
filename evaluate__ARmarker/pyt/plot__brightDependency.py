...
def display():
    ...
    datFile = "dat/dependency__imageLight.dat"
    pngFile = "png/dependency__imageLight.png"
    ...
    fig.add__plot( xAxis=Data[:,illum_], yAxis=Data[:,accu_] )
    fig.set__axis()
    fig.save__figure()
